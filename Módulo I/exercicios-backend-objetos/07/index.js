...
//Percorrer  cada item e adicionar uma nova propriedade.
livro.capitulos.numero = 0
for (let item of livro.capitulos){
    
    livro.capitulos.numero += 1
    //console.log(livro.capitulos.numero) Contabiliza os capítulos
}